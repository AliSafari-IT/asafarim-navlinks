import{r as b,a as S,R as k}from"./react-nf7bT_Uh.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&t(d)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();var j={exports:{}},u={};/**
 * @license React
...
/>`})]}),e.jsxs("div",{className:"demo-section",children:[e.jsx("h2",{className:"demo-title",children:"🎨 Navigation with Icons"}),e.jsx("p",{className:"demo-description",children:"Navigation links with Font Awesome icons on left and right sides:"}),e.jsx("div",{className:"nav-demo",children:e.jsx(h,{links:n,baseLinkStyle:{listStyle:"none",display:"flex",gap:"20px",margin:0,padding:0}})}),e.jsx(m,{code:`const iconsNavLinks: NavLinkType[] = [
...
];`})]}),e.jsxs("div",{className:"demo-section",children:[e.jsx("h2",{className:"demo-title",children:"😊 Navigation with Emojis"}),e.jsx("p",{className:"demo-description",children:"Fun navigation using emojis as visual indicators:"}),e.jsx("div",{className:"nav-demo",children:e.jsx(h,{links:t,baseLinkStyle:{listStyle:"none",display:"flex",gap:"20px",margin:0,padding:0}})}),e.jsx(m,{code:`const emojiNavLinks: NavLinkType[] = [
  { label: 'Home', href: '#home', emoji: '🏠' },
  { label: 'About', href: '#about', emoji: '📖' },
  { label: 'Services', href: '#services', emoji: '🛠️' },
  { label: 'Contact', href: '#contact', emoji: '📞' }
];`})]}),e.jsxs("div",{className:"demo-section",children:[e.jsx("h2",{className:"demo-title",children:"📁 Dropdown Navigation"}),e.jsx("p",{className:"demo-description",children:"Multi-level navigation with dropdown menus and nested submenus:"}),e.jsx("div",{className:"nav-demo",children:e.jsx(h,{links:o,baseLinkStyle:{listStyle:"none",display:"flex",gap:"20px",margin:0,padding:0},subLinkStyle:{backgroundColor:"#34495e",padding:"10px",borderRadius:"4px",minWidth:"200px",zIndex:1e3}})}),e.jsx(m,{code:`const dropdownNavLinks: NavLinkType[] = [
  { label: 'Home', href: '#home', iconLeft: 'fas fa-home' },
  {
    label: 'Products',
    href: '#products',
...
];`})]}),e.jsxs("div",{className:"demo-section",children:[e.jsx("h2",{className:"demo-title",children:"🖼️ Navigation with Logo/SVG"}),e.jsx("p",{className:"demo-description",children:"Navigation with custom SVG icons and logos:"}),e.jsx("div",{className:"nav-demo-light",children:e.jsx(h,{links:i,baseLinkStyle:{listStyle:"none",display:"flex",gap:"20px",margin:0,padding:0,alignItems:"center"}})}),e.jsx(m,{code:`const logoNavLinks: NavLinkType[] = [
  {
    label: 'Brand',
    href: '#brand',
    svgLogoIcon: {
...
/>`})]}),e.jsxs("div",{className:"demo-section",children:[e.jsx("h2",{className:"demo-title",children:"🚀 Getting Started"}),e.jsx("p",{className:"demo-description",children:"To use the asafarim-navlinks package in your project:"}),e.jsx(m,{code:`# Install the package
